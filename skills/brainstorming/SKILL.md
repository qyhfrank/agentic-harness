...
Trivial exemption: single file, clear target, < 3 steps, and mechanical — state the intended change in one or two lines, get user confirmation, then proceed without the full design flow.
</HARD-GATE>
